...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            best_model_score=max(sorted([r['test_r2'] for r in model_report.values()]))
            best_model_name=list(model_report.keys())[list([r['test_r2'] for r in model_report.values()]).index(best_model_score)]
